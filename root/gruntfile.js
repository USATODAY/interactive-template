...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    ftp: {
      ...
      upload1: {
        files: {
          '/17200/experiments/usatoday/{%=year%}/{%=month%}/{%=name%}/': 'js/main.js'
        }
      },
      upload2: {
        files: {
          '/17200/experiments/usatoday/{%=year%}/{%=month%}/{%=name%}/': 'style/project.css'
        }
      },
      upload3: {
        files: {
          '/17200/experiments/usatoday/{%=year%}/{%=month%}/{%=name%}/': 'data/*.json'
        }
      }
    },
